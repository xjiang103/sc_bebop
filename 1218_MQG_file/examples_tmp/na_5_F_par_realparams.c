...
int main(int argc,char *args[]){
  ...
  b_term = 185*2*PETSC_PI;
  b_tt1 = 0.21*2*PETSC_PI;
  b_tt2 = 0.027*2*PETSC_PI;
  ...
  add_ham_term(qsys,b_tt1,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,b_tt1,4,atoms[1][r],atoms[1][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_tt1,4,atoms[1][r],atoms[1][r],atoms[4][r],atoms[4][r]);
  add_ham_term(qsys,b_tt1,4,atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_tt2,4,atoms[2][r],atoms[2][r],atoms[4][r],atoms[4][r]);
  add_ham_term(qsys,b_tt2,4,atoms[3][r],atoms[3][r],atoms[4][r],atoms[4][r]);
