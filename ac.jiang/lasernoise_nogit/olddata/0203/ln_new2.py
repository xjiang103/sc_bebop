...
fmax=0.5*omega_0/(2*math.pi)
nf=50000
fmin=fmax/nf
df=fmin

fcmin=0
fcmax=0.5*omega_0/(2*math.pi)
dfc=0.01*omega_0/(2*math.pi)
nl=1
...
#    s2_fmax.append(res[1])
    y2_fmax.append((3/16)*(4)**2*(np.pi)**2*(lwset*fmax/np.pi)**2/((omega_0/(2*math.pi))**4))
