...
int main(int argc,char *args[]){
  ...
  add_ham_term(qsys,b_term-4*deltab,4,atoms[0][r],atoms[0][r],atoms[1][r],atoms[1][r]);
  add_ham_term(qsys,b_term-3*deltab,4,atoms[0][r],atoms[0][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,b_term-2*deltab,4,atoms[0][r],atoms[0][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_term-1*deltab,4,atoms[0][r],atoms[0][r],atoms[4][r],atoms[4][r]);  
  ...
  add_ham_term(qsys,b_term+2*deltab,4,atoms[1][r],atoms[1][r],atoms[4][r],atoms[4][r]);
  add_ham_term(qsys,b_term+3*deltab,4,atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_term+4*deltab,4,atoms[2][r],atoms[2][r],atoms[4][r],atoms[4][r]);
  add_ham_term(qsys,b_term+5*deltab,4,atoms[3][r],atoms[3][r],atoms[4][r],atoms[4][r]);
